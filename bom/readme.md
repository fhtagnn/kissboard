# Parts list
Parts required for the kissboard Keyboard

## Keyboard

Line | Description | Quantity | Links
--- | --- | --- | ---
1 | kissboard Keyboard PCB | 4 | [files](https://github.com/fhtagnn/kissboard/tree/master/gerber), [ordering](https://pcbshopper.com)
...
6 | CR2032 Battery | 2 | 
7 | Cherry MX or compatible switches | 46 |
8 | Keycaps | 46x 1U | 
...
Line | Description | Quantity | Links
--- | --- | --- | ---
1 | Receiver Interface PCB | 1 | [files](https://github.com/reversebias/mitosis-hardware/tree/master/gerbers), [ordering](https://pcbshopper.com)
